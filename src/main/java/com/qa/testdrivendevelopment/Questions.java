...
public class Questions {
	...
	public String sandwichFilling(String sandwich) {
		...
		String s = "xtbreadbreadx";
		String reverse = "";
		

		
		System.out.println("Reversed string containing 2 bread indexes is: ");
//		
//		System.out.println(str1.contains("bread"));
//		
		System.out.println(s.lastIndexOf(s));
		System.out.println(s.indexOf("bread"));
		System.out.println(s);
		

//		
		if (s.indexOf("bread") == 2) {
			for(int i = s.length() -1; i>=0; i--) {
				reverse = reverse + s.indexOf("bread");
			}
...
//		this.n = n;
		String stri = input;
		String stri_ = stri.substring(0, stri.length()-n);
		System.out.println(stri_);
		
		
//		String input = "xtbreadbreadx";
//		int n = 3;
//		
	...
	public int superBlock(String input) {
		...
		for(int i=0; i<strname.length(); i++){
			...
			if(i==0){
				...
				if(strname.charAt(i)==strname.charAt(i-1)){
					count++;
					if(maxc<count){
						maxc = count;
					}
...
//		input = "100,23";
//		ArrayList<Integer> ints = Arrays.stream(line.split(","))
